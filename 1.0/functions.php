...
/* Readme and configuration: https://github.com/ajillion/PHP-MySQLi-Database-Class */
...
function clean($str) { /* sanatize strings for databases & security */
  $str = @trim($str);
	...
	$mysqli = mysqli_connect("localhost", "root", "AA3x8-fpe50-m8eeq-w4x7v-x6r8f", "snelkoppeling") ;
